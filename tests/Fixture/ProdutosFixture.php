...
class ProdutosFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'id_produto' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        'produto' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_produto'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
